...
from .api import calculators, convert, diagnostics, documents, entities, entities_edit, exports, lan, reference, search, system
...
def create_app() -> FastAPI:
    ...
    for r in (documents.router, entities.router, entities_edit.router, search.router, calculators.router, reference.router, exports.router, convert.router, diagnostics.router, lan.router, system.router):
